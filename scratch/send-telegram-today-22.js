...
async function main() {
  const briefingPath = path.join(__dirname, '../output/2026-06-22-ai-tech-briefing.md');
  ...
  const wikiUpdateMessage = `📚 *Wiki updated:* trending news 2026-06-22 saved. Total: 149 pages.`;
