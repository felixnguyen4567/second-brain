...
const TOPIC = "Agentic Video Production — Hệ thống tự tạo và biên tập video tự động bằng AI";
const TYPE = "JOURNAL";
const PILLAR = "Website Article (long-form)";
const SLUG = "agentic-video-production-ai-automation";
...
const SOCIAL_COPIES = {
  x: `Sản xuất video đa kênh mà không cần tuyển Editor hay Voice Actor?
...
Chi tiết kiến trúc và code mẫu mình chia sẻ trong bài viết mới nhé! 👇`,
  ...
  fb: `🚀 AGENTIC VIDEO PRODUCTION: Automate your multi-channel video creation pipeline with AI!
...
#AI #VideoAutomation #Remotion #ElevenLabs #Whisper #SoftwareEngineering #FelixAIDaily`,
  ...
  li: `Video is the highest-converting content medium, yet it remains the most human-intensive bottleneck in the content factory.
...
#SoftwareEngineering #WebDevelopment #Remotion #GenerativeAI #VideoProduction #Serverless`,
  ...
  ig: `📸 Lập trình video ngắn tự động bằng React? 🎥💻
...
Drop a comment if you want the boilerplate template!`,
  ...
  tt: `[0-2s HOOK — Nói thẳng vào camera đầy hào hứng, màn hình đằng sau hiện code React Remotion]
...
async function main() {
  console.log('♟️ Starting Agentic Video Production Content Generation & Injection...');

  // 1. Save locally in output/
  const today = new Date();
  const todayStr = today.toISOString().split('T')[0];
  const outputFilename = `${todayStr}-agentic-video-social.md`;
