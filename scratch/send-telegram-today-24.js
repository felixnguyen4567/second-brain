...
async function main() {
  const briefingPath = path.join(__dirname, '../output/2026-06-24-ai-tech-briefing.md');
  ...
  const wikiUpdateMessage = `📚 *Wiki updated:* trending news 2026-06-24 saved. Total: 151 pages.`;
