...
async function main() {
  const briefingPath = path.join(__dirname, '../output/2026-06-26-ai-tech-briefing.md');
  ...
  const wikiUpdateMessage = `📚 *Wiki updated:* trending news 2026-06-26 saved. Total: 152 pages.`;
